    ...
    >
      ...
      >
        <div className="p-6">
            <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <h3 className="text-lg leading-6 font-bold text-slate-900 dark:text-white" id="confirmation-title">
                        {title}
                    </h3>
                    <div className="mt-2">
        ...
        <div className="bg-slate-50 dark:bg-slate-800/60 px-6 py-4 flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-3 rounded-b-xl">
            ...
            <button
                type="button"
                className={`w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-slate-800 sm:w-auto sm:text-sm transition-colors ${confirmButtonClass}`}
